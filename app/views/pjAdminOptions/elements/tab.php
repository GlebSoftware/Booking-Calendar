...
if (isset($tpl['arr']))
{
	if (is_array($tpl['arr']))
	{
		...
		{
			?>
			<?php if (@$_GET['tab'] == 1 && (int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
			...
			<div class="clear_right">
				...
				for ($i = 0; $i < $count; $i++)
				{
					if ((int) $tpl['arr'][$i]['is_visible'] === 0 || in_array($tpl['arr'][$i]['key'], array('o_security', 'o_bf_adults', 'o_bf_adults_max', 'o_bf_children', 'o_bf_children_max'))) continue;
