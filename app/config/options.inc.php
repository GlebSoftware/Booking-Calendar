...
if (!defined("PJ_SCRIPT_VERSION")) define("PJ_SCRIPT_VERSION", "4.4");
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "24");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "4.4.0");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjBackup', 'pjLog', 'pjInstaller', 'pjPaypal', 'pjAuthorize', 'pjOneAdmin', 'pjSms', 'pjPrice', 'pjPeriod', 'pjCountry');
?>